                ...
                <div class="pt-4">
                    <div class="card shadow-sm">
                        <div class="card-header text-center">
                            <h1 class="display-5 fw-bold mt-3">Manajemen Pelanggaran</h1>
                            <p class="lead">Kelola data pelanggaran, tugas, sanksi, dan laporan di sini.</p>
                        </div>
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="card text-center shadow-sm content-box">
                                        <div class="card-body">
                                            <h5 class="card-title">Transaksi Pelanggaran</h5>
                                ...
                                <div class="col-md-4">
                                    <div class="card text-center shadow-sm content-box">
                                        <div class="card-body">
                                            <h5 class="card-title">Cek Tugas</h5>
